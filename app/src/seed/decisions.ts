...
export const interimDecisions: Decision[] = [
  ...
  // phases. Authorizes PLANNING only. Canonical ST-DEC id Product-Owner-pending.
  {
    ...
    implementationConsequences: 'Completion Program Rev 2 (commit b6c9305) approved by the Product Owner (2026-07-25) as the governing SCS Platform Completion Program. Six architectural decisions approved (capability-based model authoritative; domain-based measurement as initial governance model; Trust/Security separation; Platform Architecture governance required; SDK strategy Not Applicable for current scope; Platform Evolution governance required before final production acceptance). Completion estimate ~25% approved as an order-of-magnitude planning measure. Assignment closed; deliverable accepted; review gate closed. Canonical identifiers for the approved decisions await the separately-resolved identifier standard. Baseline v1.0 unaltered. Does NOT authorize Phase 6 or any implementation.',
    implementationStatus: 'Verified and Accepted',
    authoritativeTextByProductOwner: true,
    queue: 'owner-action',
    authorityStatus: 'approved',
  ...
  // (2026-07-25). Authorizes PLANNING/authorization-preparation only. Canonical ST-DEC id pending.
  {
    ...
    implementationConsequences: 'Phase 6 Authorization Package accepted by the Product Owner (2026-07-25, commit 51a9557) as the authoritative Phase 6 planning document. Ten Phase 6 decisions resolved (native identity; sessions+MFA; DB session store; no new human users; agents propose-only; PO sole non-delegable authority; Trust≠Security; server-sole authorization boundary; bounded scope). Required addition produced: AUTHENTICATION_AND_AUTHORITY_PRINCIPLES.md (constitutional architecture). Phase 6 IMPLEMENTATION NOT AUTHORIZED; no implementation-governed records created. Canonical identifiers deferred.',
    implementationStatus: 'Verified and Accepted',
    authoritativeTextByProductOwner: true,
    queue: 'owner-action',
    authorityStatus: 'approved',
  ...
  // Directive (2026-07-25). Canonical ST-DEC id Product-Owner-pending.
  {
    ...
    implementationConsequences: 'Phase 6 implemented on the Slim 4 + MySQL backend and runtime-verified in CI (commit 30d4216 green; 9c0e33c reported state — both preserved as accepted revisions). Product Owner accepted it as Implemented, Verified & Accepted (2026-07-25) with decisions: Administrator MFA optional in Phase 6; infrastructure rate-limiting deferred to Phase 10; client login UI outside Phase 6; full Technical Audit Log remains Phase 8. Does NOT authorize Phase 7, confidential data, hosting, deployment, or launch.',
    implementationStatus: 'Verified and Accepted',
    authoritativeTextByProductOwner: true,
    queue: 'owner-action',
    authorityStatus: 'approved',
    demonstration: false,
    confidence: 'high',
    notes: 'Phase 6 accepted by Product Owner 2026-07-25 (ST-DLV-2026-010 accepted, rgate-010 closed, adr-011 closed). Canonical ST-DEC identifier Product-Owner-pending; not originated by #SCS.',
  },
];
