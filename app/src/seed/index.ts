...
const products: Product[] = [
  {
    ...
    lifecycleStage: 'Phase 7 Accepted · Awaiting Phase 8 Authorization',
    status: 'Active — internal platform. Phase 7 (Server-Side Constitutional Derivation & Canonical State Authority) Implemented, Verified & Accepted — the server is the sole constitutional derivation authority. Phase 6 Accepted · Baseline v1.0 Established · Completion Program Rev 2 Governing (~50% accepted, recomputed post-Phase-7). Phase 8 NOT authorized; Not Operational, Not Production, not launched.',
...
const aiCollaborators: AICollaborator[] = [
  ...
  },
  {
    ...
    currentTask: 'Phase 7 ACCEPTED by Product Owner (2026-07-25) — Server-Side Constitutional Derivation & Canonical State Authority Implemented, Verified & Accepted (the server is the sole constitutional derivation authority). Recorded acceptance: ST-DLV-2026-012 accepted, rgate-012 closed, adr-013 closed; Completion Register updated and estimate recomputed (~50%). Produced the Required Addition GOVERNED_COMMAND_PRINCIPLES.md — completing the constitutional trilogy. No further phase work initiated.',
    waitingState: 'Awaiting a separate Product Owner Phase 8 Authorization Directive',
    expectedNextAction: 'Begin no Phase 8 planning/implementation, confidential data, hosting, deployment, or launch work until separately authorized.',
    syncState: 'Synchronized',
