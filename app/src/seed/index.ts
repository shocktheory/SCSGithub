...
const products: Product[] = [
  {
    ...
    lifecycleStage: 'Phase 5 accepted (Backend Foundation & Persistence) — eligible for Phase 6 authorization (Phase 6 not authorized)',
    status: 'Active — internal platform. Phase 5 accepted by Product Owner. Not operational; not production-ready; internal only.',
