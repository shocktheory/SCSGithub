...
const products: Product[] = [
  {
    ...
    demonstration: false,
    confidence: 'high',
    notes: 'Status dimensions (independent): Portfolio Status: Active · Implementation Status: Phase 5 Accepted · Baseline Status: Production Baseline v1.0 — Accepted (authoritative comparison point for every future review; immutable except through approved supersession; Baseline Identifier Product-Owner-pending) · Operational Status: Not Operational · Production Status: Not Production · Commercial Status: Internal · Lifecycle: Awaiting Phase 6 Authorization. Completion Program Status: Authorized for Planning · Launch Status: Not Authorized · Phase 6 Status: Not Authorized. Constitutional capability (separate dimension): Accepted, Verified, Operational. Phase/work/readiness derive from linked governed records; no additional readiness is inferred. Completion is required (Platform Completion Mandate); phase progression remains governed.',
  },
  {
    id: 'prod-kidlytics',
    name: 'Kidlytics',
