...
export const deliverables: Deliverable[] = [
  ...
  { id: 'dlv-008', deliverableId: 'ST-DLV-2026-008', title: 'SCS Platform Completion Program (Rev 2 — capability-based, governance-first)', assignmentDirective: 'adr-009', reviewGate: 'rgate-008', status: 'In review — Rev 2 revisions submitted (SCS Platform Completion Program Review)', authorityStatus: 'reported', demonstration: false, notes: 'Rev 2 per Product Owner review: capability-based completion model (Domain→Capability→Requirements→Evidence); added Platform Architecture Completion; consolidated Operational Readiness; added Platform Evolution Governance; separated Platform Trust from Security; governance-first narrative (domains). ~25% accepted (capability-weighted). Planning only — approval authorizes no implementation phase or launch. See SCS_PLATFORM_COMPLETION_PROGRAM.md.' },
];
