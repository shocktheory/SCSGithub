...
export const operationalHistory: OperationalHistoryEntry[] = [
  ...
  { id: 'oh-004', entryId: 'ST-OPH-2026-004', date: '2026-07-24', agent: 'ai-cia', summary: 'AGENT-005 (#CIA) constitutionally activated: ST-SDR-2026-005 v1.0 Current; TEAM-001 membership Active; Operational — Awaiting First Assignment.', evidenceType: 'Constitutional activation', relatedObject: 'sdr-005', authorityStatus: 'approved', demonstration: false },
];
